...
//   // Check if there are any widgets with no data and labels
//   const hasNoDataWidgets = (widgets) => {
//     return widgets.some(widget => widget.data.length === 0 || widget.labels.length === 0);
//   };
